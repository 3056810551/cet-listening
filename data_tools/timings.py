...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Generate CET transcript/timings JSON files.")
    parser.add_argument(
        "markdown",
        help="Markdown transcript path, for example transcripts/cet6/2025-12-2.md",
    )
    parser.add_argument(
        "audio",
        nargs="?",
        help="Audio path, for example audio/cet6/2025-12-2.mp3",
    )
    parser.add_argument(
        "--transcript-only",
        action="store_true",
